...
class Recorder: NSObject {
    ...
    // Iniciar el temporizador para grabar fotogramas
    func startRecording() {
    ...
    // Dibujar el bot y guardarlo como fotograma
    ...
    // Dejar de grabar y presentar el botón para guardar
    ...
    // Presentarle al usuario un panel para guardar los cambios
    ...
    // Escribir cada fotograma guardado para generar un .gif
